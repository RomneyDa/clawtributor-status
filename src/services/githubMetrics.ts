import activitySearchQuery from "../../packages/github-contract/queries/activity-search.graphql?raw";
import contributionsQuery from "../../packages/github-contract/queries/contributions.graphql?raw";
